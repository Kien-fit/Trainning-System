...
/*		
		...
		out.print("<i class=\"fas fa-user-circle\"></i> Account");
		out.print("</button>");
		out.print("</h2>");
		out.print("</div>");
		...
		out.print("<div class=\"card-body\">");
		out.print("<a href=\"/adv/custumer/view\"><i class=\"fas fa-clipboard-list\"></i> Danh Sách</a><br />");
		out.print("<a href=\"/adv/custumer/ae\"><i class=\"fas fa-plus-circle\"></i> Thêm mới</a>");
		out.print("</div>");
		out.print("</div>");
		out.print("</div>");	
		...
		out.print("<div class=\"card-body\">");
		out.print("<a href=\"/adv/interior/view\"><i class=\"fas fa-clipboard-list\"></i> Danh Sách</a><br />");
		out.print("<a href=\"/adv/interior/ae\"><i class=\"fas fa-plus-circle\"></i> Thêm mới</a>");
		out.print("</div>");
		out.print("</div>");
		out.print("</div>");
		...
		out.print("<div class=\"card-body\">");
		out.print("<a href=\"/adv/computer/view\"><i class=\"fas fa-clipboard-list\"></i> Danh Sách</a><br />");
		out.print("<a href=\"/adv/computer/ae\"><i class=\"fas fa-plus-circle\"></i> Thêm mới</a>");
		out.print("</div>");
		out.print("</div>");
		out.print("</div>");
