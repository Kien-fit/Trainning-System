 ...
 */
@WebServlet("/pc/view")
public class ProductCategoryView extends HttpServlet {
	...
	protected void view(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String view = pcc.viewProductCategory(null, (short)1, (byte)10);
		...
		out.print("<form class=\"form-inline\" name=\"frmSearch\" action=\"/adv/pc/view\" method=\"POST\">");
