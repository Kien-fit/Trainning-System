...
public class ProductSystemControl {
	...
	public ProductSystemControl(ConnectionPool cp) {
		this.pm = new ProductSystemModel(cp);
	}
	...
	public String viewUserOptions(UserObject user) {
		ArrayList<UserObject> users = this.pm.getUserObjects(user);
		return ProductSystemLibrary.viewUserOptions(users);
	}
