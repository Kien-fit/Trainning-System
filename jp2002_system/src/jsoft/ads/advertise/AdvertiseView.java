 ...
 */
@WebServlet("/advertise/view")
public class AdvertiseView extends HttpServlet {
	...
	protected void view(HttpServletRequest request, HttpServletResponse response, UserObject user) throws ServletException, IOException {
		...
		AdvertiseControl ac = new AdvertiseControl(cp);
		...
		AdvertiseObject similar = new AdvertiseObject();
		...
		similar.setAdvertise_title(saveKey);
		
		// Lấy cấu trúc trình bày
		String view = ac.viewAdvertises(similar, (short) 1, (byte) 30);
		...
		out.print("<li class=\"breadcrumb-item\"><a href=\"/adv/advertise/view\">Quảng cáo</a></li>&nbsp;");
		out.print("<li class=\"breadcrumb-item\"><a href=\"/adv/advertise/view\">Danh sách</a></li>");
		out.print("</ol>");
		out.print("</nav>");
		out.print("</div>");
		out.print("<div class=\"col-md-4\">");
		out.print("<div class=\"view-search\">");
		out.print("<form class=\"form-inline\" name=\"frmSearch\" action=\"/adv/advertise/view\" method=\"POST\">");
