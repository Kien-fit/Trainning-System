...
public class AccountView extends HttpServlet {
	...
	protected void view(HttpServletRequest request, HttpServletResponse response, UserObject user) throws ServletException, IOException {
		...
		AccountControl ac = new AccountControl(cp);
		...
		AccountObject similar = new AccountObject();
		...
		similar.setCustomer_fullname(saveKey);
		
		// Lấy cấu trúc trình bày
		String view = ac.viewAccounts(similar, (short) 1, (byte) 30);
		...
		out.print("<li class=\"breadcrumb-item\"><a href=\"/adv/customer/view\">Khách hàng</a></li>&nbsp;");
		out.print("<li class=\"breadcrumb-item\"><a href=\"/adv/account/view\">Tài khoản</a></li>&nbsp;");
		out.print("<li class=\"breadcrumb-item\"><a href=\"/adv/account/view\">Danh sách</a></li>");
		out.print("</ol>");
		out.print("</nav>");
		out.print("</div>");
		out.print("<div class=\"col-md-4\">");
		out.print("<div class=\"view-search\">");
		out.print("<form class=\"form-inline\" name=\"frmSearch\" action=\"/adv/account/view\" method=\"POST\">");
