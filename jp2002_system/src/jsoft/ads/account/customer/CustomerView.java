...
public class CustomerView extends HttpServlet {
	...
	protected void view(HttpServletRequest request, HttpServletResponse response, UserObject user) throws ServletException, IOException {
		...
		String view = cc.viewCustomers(similar, (short) 1, (byte) 30);
		...
		out.print("<li class=\"breadcrumb-item\"><a href=\"/adv/customer/view\">Danh sách</a></li>");
		out.print("</ol>");
		out.print("</nav>");
		out.print("</div>");
		out.print("<div class=\"col-md-4\">");
		out.print("<div class=\"view-search\">");
		out.print("<form class=\"form-inline\" name=\"frmSearch\" action=\"/adv/customer/view\" method=\"POST\">");
