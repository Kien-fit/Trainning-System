 ...
 */
@WebServlet("/pattern/view")
public class PatternView extends HttpServlet {
	...
	protected void view(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PatternControl oc = new PatternControl(cp);
		...
		PatternObject similar = new PatternObject();
		//Truyền từ khóa tìm kiếm vào tên đăng nhập
		similar.setPattern_title(saveKey);
		
		// Lấy cấu trúc trình bày
		String view = oc.viewPatterns(null, (short)1, (byte)10);
		...
		out.print("<li class=\"breadcrumb-item\"><a href=\"/adv/pattern/view\">Mẫu</a></li>&nbsp;");
		...
		out.print("<form class=\"form-inline\" name=\"frmSearch\" action=\"/adv/pattern/view\" method=\"POST\">");
