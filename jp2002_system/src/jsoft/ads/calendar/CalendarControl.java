...
public class CalendarControl {
	...
	public CalendarControl(ConnectionPool cp, String objectname) {
...
//						item.setCalendar_last_modified(rs.getString("calendar_last_modified"));
		...
		public ArrayList<CalendarObject> getCalendarObject(CalendarObject similar, short page, byte total) {
