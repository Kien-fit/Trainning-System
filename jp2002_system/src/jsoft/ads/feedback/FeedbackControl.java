...
public class FeedbackControl {
	...
	public FeedbackControl(ConnectionPool cp, String objectname) {
	...
	// ------------------------------------------------
		...
		public ArrayList<FeedbackObject> getFeedbackObject(FeedbackObject similar, short page, byte total) {
