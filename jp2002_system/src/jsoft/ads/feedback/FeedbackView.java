...
public class FeedbackView extends HttpServlet {
	...
	protected void view(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		similar.setFeedback_title(saveKey);
		
		// Lấy cấu trúc trình bày
		String view = fc.viewFeedbacks(null, (short)1, (byte)10);
		...
		out.print("<li class=\"breadcrumb-item\"><a href=\"/adv/feedback/view\">Phản hồi</a></li>&nbsp;");
		...
		out.print("<form class=\"form-inline\" name=\"frmSearch\" action=\"/adv/feedback/view\" method=\"POST\">");
