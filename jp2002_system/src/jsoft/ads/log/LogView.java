...
public class LogView extends HttpServlet {
	...
	protected void view(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		similar.setLog_name(saveKey);
		
		// Lấy cấu trúc trình bày
		String view = lc.viewLogs(null, (short)1, (byte)10);
		...
		out.print("<li class=\"breadcrumb-item\"><a href=\"/adv/log/view\">Log</a></li>&nbsp;");
		...
		out.print("<form class=\"form-inline\" name=\"frmSearch\" action=\"/adv/log/view\" method=\"POST\">");
