...
public class ArticleView extends HttpServlet {
	...
	protected void view(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArticleExtendsControl ac = new ArticleExtendsControl(cp);
		...
		ArticleExtendsObject similar = new ArticleExtendsObject();
		//Truyền từ khóa tìm kiếm vào tên đăng nhập
		similar.setArticle_title(saveKey);
		
		// Lấy cấu trúc trình bày
		String view = ac.viewArticleExtends(null, (short)1, (byte)10);
		...
		out.print("<li class=\"breadcrumb-item\"><a href=\"/adv/ae/view\">Bài viết mở rộng</a></li>&nbsp;");
		...
		out.print("<form class=\"form-inline\" name=\"frmSearch\" action=\"/adv/ae/view\" method=\"POST\">");
