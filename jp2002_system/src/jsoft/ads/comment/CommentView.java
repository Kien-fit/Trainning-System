...
public class CommentView extends HttpServlet {
	...
	protected void view(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		CommentObject similar = new CommentObject();
		//Truyền từ khóa tìm kiếm vào tên đăng nhập
		similar.setComment_title(saveKey);
		
		// Lấy cấu trúc trình bày
		String view = cc.viewComments(null, (short)1, (byte)10);
		...
		out.print("<li class=\"breadcrumb-item\"><a href=\"/adv/comment/view\">Bình luận</a></li>&nbsp;");
		...
		out.print("<form class=\"form-inline\" name=\"frmSearch\" action=\"/adv/comment/view\" method=\"POST\">");
