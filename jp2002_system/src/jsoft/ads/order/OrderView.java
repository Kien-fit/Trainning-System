...
public class OrderView extends HttpServlet {
	...
	protected void view(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String view = oc.viewOrders(null, (short)1, (byte)10);
		...
		out.print("<li class=\"breadcrumb-item\"><a href=\"/adv/order/view\">Đơn hàng</a></li>&nbsp;");
		...
		out.print("<form class=\"form-inline\" name=\"frmSearch\" action=\"/adv/order/view\" method=\"POST\">");
