...
public class ProductGroupObject extends ProductSystemObject {
	...
	private boolean pg_enable;//Hien thi hay khong
	private String pg_name_en;//Ten Nhom san pham tieng Anh
