...
public class ValueObject {
	...
	public short getValue_label_id() {
		return value_label_id;
	}
	public void setValue_label_id(short value_label_id) {
		this.value_label_id = value_label_id;
	}
